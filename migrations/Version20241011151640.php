 ...
 */
final class Version20241011151640 extends AbstractMigration
{
    ...
    {
        $this->abortIf(!$this->connection->getDatabasePlatform() instanceof PostgreSQLPlatform, 'Migration can only be executed safely on \'pgsql\'.');

        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE basic_page (id SERIAL NOT NULL, meta_information_id INT DEFAULT NULL, location VARCHAR(255) NOT NULL, publish BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE basic_page_translation (id SERIAL NOT NULL, translatable_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) DEFAULT NULL, content TEXT NOT NULL, locale VARCHAR(5) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE book (id SERIAL NOT NULL, category_id INT DEFAULT NULL, picture_id INT DEFAULT NULL, publish BOOLEAN NOT NULL, position INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE book_translation (id SERIAL NOT NULL, translatable_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, locale VARCHAR(5) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE category_translation (id SERIAL NOT NULL, translatable_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, locale VARCHAR(5) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE cookies_page (id SERIAL NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE cookies_page_translation (id SERIAL NOT NULL, translatable_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, content TEXT DEFAULT NULL, locale VARCHAR(5) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE entity_meta_information (id SERIAL NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE entity_meta_information_translation (id SERIAL NOT NULL, translatable_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, locale VARCHAR(5) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE media__gallery (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, context VARCHAR(64) NOT NULL, default_format VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE media__gallery_media (id SERIAL NOT NULL, gallery_id INT DEFAULT NULL, media_id INT DEFAULT NULL, position INT NOT NULL, enabled BOOLEAN NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE meta_information_translation (id SERIAL NOT NULL, translatable_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, locale VARCHAR(5) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE redirect (id SERIAL NOT NULL, source VARCHAR(500) NOT NULL, destination VARCHAR(500) NOT NULL, http_code INT NOT NULL, automatic BOOLEAN NOT NULL, publish BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C30C9E2B5F8A7F73 ON redirect (source)');
        $this->addSql('CREATE TABLE translation (id SERIAL NOT NULL, translation_key VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B469456FAADCBD56 ON translation (translation_key)');
        $this->addSql('CREATE TABLE translation_translation (id SERIAL NOT NULL, translatable_id INT DEFAULT NULL, value TEXT DEFAULT NULL, locale VARCHAR(5) NOT NULL, PRIMARY KEY(id))');
